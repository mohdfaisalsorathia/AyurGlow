  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <img src="/images/green-nature-bg.png" alt="" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-forest-900/50 via-forest-800/40 to-forest-900/55" />
      </div>
